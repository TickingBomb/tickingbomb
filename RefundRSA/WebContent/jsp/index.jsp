    ...
    <div class="content">
        <form action="alipayapi.jsp" class="alipayform" method="POST" target="_blank">
            ...
            <div class="element">
                ...
                <div class="einput"><input type="text" name="WIDbatch_no" id="batch_no"></div>
                <br>
            ...
            <div class="element">
                ...
                <div class="einput"><input type="text" name="WIDbatch_num" value="1"></div>
                <br>
                <div class="mark">注意：退款笔数(batch_num)，必填(值为您退款的笔数,取值1~1000间的整数)</div>
            </div>
            <div class="element">
                <div class="etitle">退款详细数据:</div>
                <div class="einput"><input type="text" name="WIDdetail_data" value="2017082921001004740215337654^1^beautiful"></div>
                <br>
                <div class="mark">注意：退款详细数据(WIDdetail_data)，必填(支付宝交易号^退款金额^备注)多笔请用#隔开</div>
            </div>
            <div class="element">
                <input type="submit" class="alisubmit" value ="确认">
            </div>
        </form>
    </div>
    <div class="footer">
